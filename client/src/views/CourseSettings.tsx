...
function CourseSettings({ classItem }: Props) {
  ...
  const views = [
    ...
    },
    {
      ...
      icon: 'N/A',
      component: <FeaturePreferences classItem={classItem} />,
    },
    {
      label: 'Class Members',
      description: 'See and edit your class roster',
      icon: 'N/A',
      component: <Members classItem={classItem} />,
    },
    {
      label: 'Invite people',
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box className={'leavebutton'} _hover={{ background: hoverbg }}>
